...
- **🎄 Decorate Tree**: detailed tree decorator with:
    - Multiple tree types and background scenes.
    - Drag-and-drop ornaments (stars, gifts, balls, etc.).
    - **Share to Gallery**: Save your creation to the community gallery (compressed for efficiency).
    - **Download**: Save your tree as an image.
- **💬 Chat with Santa**: An interactive chat experience where Santa asks about your name, age, and wishes.
    - **Wish Card**: Generate and share a personalized wish card from Santa.
...
- **Functionality**:
    - `react-webcam`: For the Santa photo experience.
    - `html2canvas`: For capturing wish cards and decorated trees.
...
1.  **Clone the repository**
    ```bash
    git clone https://github.com/sahadsaleel/SantaVerse.git
    cd SantaVerse
    ```
